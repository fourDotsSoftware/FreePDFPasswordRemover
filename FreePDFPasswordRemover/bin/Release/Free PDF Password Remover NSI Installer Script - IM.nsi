...
;  File "readme.txt"
  ...
  ;File "free-pdf-password-remover-4dots-150.png"
  ...
  ;nsExec::Exec "$INSTDIR\net_updater32.exe --install win_freepdfpasswordremover.4dotssoftware.com"
...
${EndIf}  
 ...
 ;nsExec::Exec "$INSTDIR\net_updater32.exe --uninstall win_freepdfpasswordremover.4dotssoftware.com" 
...
Function .onInstSuccess
  ExecShell "" "http://www.4dots-software.com/free-pdf-password-remover/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
FunctionEnd
